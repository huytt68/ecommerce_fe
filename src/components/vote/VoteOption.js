...
const VoteOption = ({ nameProduct, handleSubmitVoteOption }) => {
	...
	return (
		<div
			...
			ref={modalRef}
			className="bg-white z-50000 w-[700px] p-4 gap-4 flex flex-col items-center justify-center"
		>
			...
			<textarea
				...
				placeholder="Cản nhận của bạn về sản phẩm"
				value={comment}
			...
			<div className="w-full flex flex-col gap-4">
				...
				<div className="flex justify-center gap-4 items-center">
					{voteOptions.map((el) => (
						<div
							className="w-[100px] h-[100px] bg-gray-200  cursor-pointer    
            rounded-md p-4 flex items-center justify-center flex-col gap-2"
							key={el.id}
							onClick={() => {
